...
model = model.fit(df[["Market Cap", "Net Income", "Cash on Hand"]], df["Yield"])


df["Prediction"]= model.predict(df[["Market Cap", "Net Income", "Cash on Hand"]])


pred_val = model.predict([[1.190000e+12 ,1.395600e+10/4 ,1.392620e+11]])
